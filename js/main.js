...
const data = {
    zhoushan: {
        intro: { title: '舟山 · 海天佛国', hero: 'images/zhoushan_putuoshan.jpg', tags: ['海岛度假', '佛教圣地', '海鲜美食'], desc: '中国第一大群岛城市，1390个岛屿宛如撒落东海的翡翠，佛教名山普陀山坐落于此', stats: [{v: '1440', l: '海域面积(km²)'}, {v: '96万', l: '常住人口'}, {v: '海鲜之城', l: '城市名片'}], spots: ['普陀山', '东极岛', '朱家尖', '桃花岛'] },
        food: { title: '舟山 · 美食地图', items: [{n: '红烧带鱼', p: '¥68', d: '舟山特产带鱼，鱼肉鲜嫩，红烧最入味', t: ['招牌', '必吃'], img: 'images/zhoushan_shanwan.jpg'}, {n: '梭子蟹炒年糕', p: '¥78', d: '舟山梭子蟹肥美，年糕吸满蟹鲜', t: ['时令', '特色'], img: 'images/zhoushan_dongji.jpg'}, {n: '海鲜面', p: '¥35', d: '一碗海鲜面，半碗都是料，鲜掉眉毛', t: ['本地人最爱', '早餐首选'], img: 'images/zhoushan_shenjiamen.jpg'}], streets: [{n: '沈家门渔港', d: '中国最大渔港，海鲜排挡一条街'}, {n: '东港海鲜城', d: '本地人推荐，价格实惠'}] },
        scenery: { title: '舟山 · 网红打卡', items: [{n: '普陀山', r: 5, d: '海天佛国，观音道场，三大佛教名山之一', t: '3-4小时', p: '¥160（不含寺庙）', img: 'images/zhoushan_putuoshan.jpg', tag: '必打卡'}, {n: '东极岛', r: 5, d: '中国最东边的海岛，电影《后会无期》取景地', t: '1-2天', p: '¥0（船票另算）', img: 'images/zhoushan_dongji.jpg', tag: '海岛'}, {n: '朱家尖', r: 4.5, d: '沙雕故乡，十里金沙，沙滩细腻', t: '3-4小时', p: '¥0（南沙收费）', img: 'images/zhoushan_shanwan.jpg', tag: '沙滩'}, {n: '桃花岛', r: 4.5, d: '金庸笔下黄药师的隐居地，春季桃花盛开', t: '1天', p: '¥0（上岛免费）', img: 'images/zhoushan_taohua.jpg', tag: '武侠'}] },
        hotel: { title: '舟山 · 住宿推荐', luxury: [{n: '舟山希尔顿酒店', p: '¥900+', l: '临城CBD', t: ['海景'], img: 'images/zhoushan_shanwan.jpg'}, {n: '普陀山雷迪森庄园', p: '¥1200+', l: '普陀山景区内', t: ['佛教氛围'], img: 'images/zhoushan_putuoshan.jpg'}], budget: [{n: '东极海舟民宿', p: '¥280+', l: '东极岛', t: ['海景'], img: 'images/zhoushan_dongji.jpg'}, {n: '朱家尖海边的家民宿', p: '¥220+', l: '朱家尖', t: ['离沙滩近'], img: 'images/zhoushan_shanwan.jpg'}] },
        other: { title: '舟山 · 实用攻略', transport: [{t: '轮渡', d: '到普陀山、东极岛需乘船', c: 'blue'}, {t: '客车', d: '宁波汽车南站有直达舟山班车', c: 'green'}, {t: '自驾', d: '杭州/宁波出发约2-3小时', c: 'yellow'}], bestTime: [{s: '🌊', t: '夏季 6-8月', d: '最适合玩海岛'}, {s: '🍂', t: '秋季 9-11月', d: '梭子蟹最肥'}, {s: '🌸', t: '春季 3-5月', d: '桃花岛赏花'的到来'}], tips: [{t: '💡', c: '上岛提前买船票', d: '旺季东极岛船票紧张'}, {t: '🚢', c: '晕船提前备药', d: '快艇较晃'}, {t: '🙏', c: '普陀山素斋不错', d: '寺庙内可用餐'}] }
    },
    shanghai: {
    ...
    wuhan: {
        ...
        food: { title: '武汉 · 美食地图', items: [{n: '热干面', p: '¥8', d: '芝麻酱香浓可口，武汉人最爱的早餐', t: ['必吃榜', '早餐首选'], img: 'images/wuhan_hotdrynoodles.jpg'}, {n: '豆皮', p: '¥10', d: '外脆内软，馅料丰富', t: ['酥脆', '排队王'], img: 'images/wuhan_doupi.jpg'}, {n: '糊汤粉', p: '¥12', d: '用鱼糊煮的米粉，汤鲜肉嫩', t: ['特色推荐', '配油条绝了'], img: 'images/wuhan_hutangfen.jpg'}], streets: [{n: '粮道街', d: '武汉本地人常去的美食街'}, {n: '万松园', d: '老字号美食聚集地'}] },
        scenery: { title: '武汉 · 网红打卡', items: [{n: '黄鹤楼', r: 5, d: '天下江山第一楼，江南三大名楼之首', t: '1-2小时', p: '¥70', img: 'images/wuhan_yellowcrane.jpg', tag: '必打卡'}, {n: '东湖', r: 5, d: '中国最大的城中湖', t: '3-4小时', p: '免费', img: 'images/wuhan_eastlake.jpg', tag: '自然'}, {n: '武汉大学', r: 4.5, d: '中国最美大学，樱花闻名全国', t: '2-3小时', p: '免费', img: 'images/wuhan_university.jpg', tag: '人文'}] },
        hotel: { title: '武汉 · 住宿推荐', luxury: [{n: '武汉香格里拉大酒店', p: '¥800+', l: '汉口江滩', t: ['江景'], img: 'images/wuhan_eastlake.jpg'}, {n: '武汉万达瑞华酒店', p: '¥900+', l: '东湖边', t: ['湖景'], img: 'images/wuhan_yellowcrane.jpg'}], budget: [{n: '如家酒店（黄鹤楼店）', p: '¥180+', l: '靠近黄鹤楼', t: ['位置好'], img: 'images/wuhan_yellowcrane.jpg'}, {n: '全季酒店（光谷店）', p: '¥200+', l: '光谷商圈', t: ['新装修'], img: 'images/wuhan_university.jpg'}] },
    ...
    beijing: {
        ...
        food: { title: '北京 · 美食地图', items: [{n: '北京烤鸭', p: '¥168-298', d: '世界闻名，酥脆鸭皮配葱丝黄瓜', t: ['招牌', '必吃'], img: 'images/beijing_duck.jpg'}, {n: '炸酱面', p: '¥25', d: '老北京传统面食，酱香浓郁', t: ['传统', '家常'], img: 'images/beijing_noodles.jpg'}, {n: '涮羊肉', p: '¥80', d: '老北京传统火锅，手切羊肉鲜嫩', t: ['特色', '暖胃'], img: 'images/beijing_hotpot.jpg'}], streets: [{n: '簋街', d: '夜宵一条街'}, {n: '南锣鼓巷', d: '老北京胡同文化'}] },
    ...
    shenzhen: {
        ...
        food: { title: '深圳 · 美食地图', items: [{n: '粤式早茶', p: '¥60-100', d: '虾饺、烧卖、凤爪、肠粉', t: ['特色', '必吃'], img: 'images/shenzhen_dimsum.jpg'}, {n: '椰子鸡', p: '¥80', d: '深圳特色，椰子水煮鸡清甜滋补', t: ['本地特色', '清淡'], img: 'images/shenzhen_cyberpark.jpg'}, {n: '光明乳鸽', p: '¥45', d: '深圳光明区特色，皮脆肉嫩', t: ['特产', '必吃'], img: 'images/shenzhen_pigeon.jpg'}], streets: [{n: '东门老街', d: '美食购物一条街'}, {n: '海岸城', d: '现代商圈美食'}] },
        scenery: { title: '深圳 · 网红打卡', items: [{n: '世界之窗', r: 4.5, d: '荟萃世界著名景观', t: '1天', p: '¥220', img: 'images/shenzhen_window.jpg', tag: '主题公园'}, {n: '东部华侨城', r: 4.5, d: '生态旅游示范区', t: '1天', p: '¥200', img: 'images/shenzhen_cyberpark.jpg', tag: '自然'}, {n: '深圳湾公园', r: 4, d: '海滨公园，可远眺香港', t: '2-3小时', p: '免费', img: 'images/shenzhen_bay.jpg', tag: '休闲'}] },
